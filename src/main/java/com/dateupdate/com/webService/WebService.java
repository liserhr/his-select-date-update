 ...
 * 
 */
@WebServiceClient(name = "WebService", targetNamespace = "http://webservice.jiekou.com", wsdlLocation = "http://11.49.253.47:8887/XfireWebService_Oracle/services/Login?wsdl")
    ...
    extends Service
{
    ...
    private final static QName WEBSERVICE_QNAME = new QName("http://webservice.jiekou.com", "WebService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://11.49.253.47:8887/XfireWebService_Oracle/services/Login?wsdl");
     ...
     */
    @WebEndpoint(name = "WebServiceHttpPort")
    public WebServicePortType getWebServiceHttpPort() {
        return super.getPort(new QName("http://webservice.jiekou.com", "WebServiceHttpPort"), WebServicePortType.class);
    }
     ...
     */
    @WebEndpoint(name = "WebServiceHttpPort")
    public WebServicePortType getWebServiceHttpPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webservice.jiekou.com", "WebServiceHttpPort"), WebServicePortType.class, features);
    }
